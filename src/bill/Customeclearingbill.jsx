                      ...
                      >
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td style={{ fontSize: 11, fontWeight: 500 }}>
                              {new Date(dataget.date_start).toLocaleDateString("en-GB")}
                            </td>
                            <td style={{ fontSize: 11, fontWeight: 500 }}>
                              {dataget.delivery_to_country}
                            </td>
                            <td style={{ fontSize: 11, fontWeight: 500 }}>{new Date(dataget.delivery_ETA).toLocaleDateString("en-GB")}</td>
                          </tr>
                          <tr style={{ border: "unset" }}>
                            <th
                              style={{
                          ...
                          {dataget.post_of_discharge}
                            ...
                            <td style={{ fontSize: 11, fontWeight: 500 }}>
                            {new Date(dataget.delivery_ETA).toLocaleDateString("en-GB")}
                            </td>
                          </tr>
                        </tbody>
                      </table>
