        ...
        <div className="container-fluid">
          <div className="card">
            <div className="card-body">
              <div className="row manageFreight">
                <div className="col-12">
                  ...
                  <div>
                                         ...
                                         <h4 className="freight_hd ms-3">Deliver Note</h4>
                  </div>
                  </div>
              ...
              <section style={{ marginTop: "10px",padding:"30px" }} ref={targetRef}>
                <div
                  style={{
                    height: "auto",
                    width: "100%",
                ...
                >
                            ...
                            <tbody>
                              ...
                              <tr>
                                <td style={{ padding: 0 }}>
                                  ...
                                  <div style={{ display: "flex", justifyContent: "end" }}>
                                    <div style={{ width: "37%", border: "1px solid #000" }}>
                                      <p
                                        style={{
                                          margin: 0,
                                          fontSize: 10,
                      ...
                      <tr>
                        <td style={{ padding: 0 }}>
                          <div style={{ width: "100%", display: "flex" }}>
                            ...
                            >
                              {datat?.container_no} {/* <p style="margin-bottom: 0px; color: white;">.</p> */}
                            </div>
                            <div
                              style={{
                                border: "1px solid black",
                        ...
                        <td style={{ padding: 0 }}>
                          <div style={{ width: "100%", display: "flex" }}>
                            ...
                            >
                              ...
                              >
                                {new Date(datat?.actual_delivery_date).toLocaleDateString("en-GB")}
                              </p>
                            </div>
                            <div
                              style={{
                            ...
                            >
                              ...
                              >
                                {new Date(datat?.delivery_ETA).toLocaleDateString("en-GB")}
                              </p>
                            </div>
                          </div>
                        </td>
                  ...
                  <table style={{ width: "100%", marginBottom: 20 }}>
                    <tbody>
                      <tr>
                        <td>
                          <div style={{ width: "22%", border: "1px solid black" }}>
                            <p
                              style={{
                                margin: 0,
                                fontSize: 10,
