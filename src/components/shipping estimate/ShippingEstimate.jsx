...
const val2 = !isNaN(origintotal) ? origintotal * freight.roe_origin_currency : 0;
const val3 = !isNaN(destationTotal) ? destationTotal * freight.roe_des_currency : 0;

// Calculate the sum of valid values
console.log(val1,  val2, val3)
const estimate = (isNaN(val1) ? 0 : val1) + 
                 (isNaN(val2) ? 0 : val2) + 
                 (isNaN(val3) ? 0 : val3);
...
console.log(finalestimate);
  ...
  const getdataapi = async() => {
    ...
    const data123456 ={
      ...
      estimate_id:getdata.estimated_id ? getdata.estimated_id : getdata.estimate_id
    } 
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td style={{ width: "50%", color: "#000" }}>
                            ...
                            <p>
                             <span>VAT Number: 4740280377</span><br /> 
                              TEL: +27 10 448 0733
                              </p>
                              <p>  </p>
                          </td>
                            ...
                            <table>
                              <tbody>
                                ...
                                {/* <tr>
                                  ...
                                  <td
                                    style={{ paddingBottom: 15, fontSize: 15 }}
                                  >
                                    2023/11/07
                                  </td>
                                </tr> */}
                          ...
                          >
                            ...
                            >
                              ...
                              <input
                                ...
                                placeholder="0.00"
                                value={
                                  isNaN(finaldestation2 * freight.roe_des_currency)
                                    ? 0
                                    : parseFloat(
                          ...
                          >
                            ...
                            >
                              ...
                              <input
                                ...
                                placeholder="0.00"
                                value={
                                  isNaN(finaldestation1 * freight.roe_des_currency)
                                    ? 0
                                    : parseFloat(
                          ...
                          >
                            ...
                            >
                              ...
                              <input
                                ...
                                placeholder="0.00"
                                value={
                                  isNaN(finaldestation3 * freight.roe_des_currency)
                                    ? 0
                                    : parseFloat(
