...
const Addfright = () => {
  ...
  const handlevalidate = (value) => {
    ...
    if (!value.client_ref_name) {
      error.client_ref_name = "client ref name is required";
    }
    if (!value.insurance) {
  ...
  const apihit = () => {
    ...
    formdata.append("assign_warehouse", data.assign_warehouse);
    ...
    if (formData.supplier_invoice && formData.supplier_invoice.length > 0) {
      ...
      formdata.append("supplier_invoice", ""); // Adds only the key with an empty value
    }
    ...
    if (formData.packing_list && formData.packing_list.length > 0) {
      ...
      formdata.append("packing_list", ""); // Adds only the key with an empty value
    }
    ...
    if (formData.licenses && formData.licenses.length > 0) {
      ...
      formdata.append("licenses", ""); // Adds only the key with an empty value
    }
    ...
    if (formData.other_documents && formData.other_documents.length > 0) {
      ...
      formdata.append("other_documents", ""); // Adds only the key with an empty value
    }
  ...
  const volumetricweight = 167 * data.dimension;
  useEffect(() => {
    getClient();
  }, []);
  const getClient = () => {
  ...
  const ghandleaddcommodity =()=>{
    ...
    axios.post(`${process.env.REACT_APP_BASE_URL}addCommodity`,data111).then((response)=>{
      if(response.data.success==="true")
        toggleModal1()
      getdataap()
      toast.success(response.data.message)
      ...
      <div className="wpWrapper ">
          ...
          <div className="modal show d-block" tabIndex="-1" role="dialog">
            <div className="modal-dialog" role="document">
              <div className="modal-content">
                ...
                <input className="form-control" name="name" onChange={handlechange} placeholder="Add Commodity"></input>
                </div>
                <div className="modal-footer">
                  ...
                  <button type="button" className="btn btn-primary" onClick={ghandleaddcommodity}>
                    Add
                  </button>
                </div>
              </div>
        ...
        <div className="container-fluid">
          ...
          <div className="card mt-4">
            <div className="card-body add_fre_cd">
              <div className="row">
                <div className="col-12">
                  <h4 className="freight_hd">Shipment details</h4>
                  ...
                  <div className="borderShip updateLoading">
                    ...
                    <div className="row">
                      ...
                      <div className="col-6">
                        ...
                        <p className="text-danger mb-0">{error.shipment_ref}</p>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="borderShip updateLoading1">
                    <div className="row">
                      ...
                      <div className="col-6">
                        ...
                        <p className="text-danger mb-0">{error.shipment_des}</p>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="borderShip updateLoading">
                    <div className="row">
                      <div className="col-6">
                        ...
                        <p className="text-danger mb-0">{error.package_type}</p>
                      </div>
                      {/* <div className="col-6">
